                    ...
                    <div className=" w-3/5 max-md:w-full flex flex-col justify-between">
                        ...
                        <div className="flex p-4 flex-wrap gap-2">
                            {project.skills.map((skill, skillIndex) => (
                                <div key={skillIndex} className="mr-4 border border-solid border-black w-fit h-8 p-2 flex justify-center items-center hover:text-white hover:bg-black transition-colors duration-150">{skill}</div>
                            ))}
                        </div>
                    </div>
                </div>
