...
describe('App', () => {
  ...
  it('should navigate to the Services section when Services link is clicked', () => {
    ...
    expect(screen.getByText("These are the technologies I've been specializing in.")).toBeInTheDocument();
  });
  ...
  it('should navigate to the About section when About link is clicked', () => {
    ...
    expect(screen.getByText("Take a look at some of the projects I've made.")).toBeInTheDocument();
  });
